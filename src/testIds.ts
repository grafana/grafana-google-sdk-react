export const TEST_IDS = {
  ...
  authTypeButtonWIF: 'WIF button',
  authTypeButtonOAuthPassthrough: 'OAuth Passthrough button',
  workloadIdentityPoolProviderInput: 'Workload Identity Pool Provider Input',
  wifServiceAccountEmailInput: 'WIF Service Account Email Input',
  oauthPassthroughDefaultProjectInput: 'OAuth Passthrough Default Project Input',
